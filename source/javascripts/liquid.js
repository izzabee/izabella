...
// function resize() {
//   canvasW = document.getElementById('wrapper').offsetWidth + 40;
//   initCanvas(canvasW, window.innerWidth);
//   var cW = canvas.width;
...
//     if (window.innerWidth / 2 - mouseY < 50 && window.innerWidth / 2 - mouseY > -50) {
//       autoDiff = 1000;
...
// function draw() {
//   ctx.beginPath();
//   ctx.moveTo(0, window.innerWidth);
//   ctx.lineTo(vertexes[0].x, vertexes[0].y);
//   for (var i = 1; i < vertexes.length; i++) {
//     ctx.lineTo(vertexes[i].x, vertexes[i].y);
//   }

//   ctx.lineTo(canvas.width, window.innerWidth);
//   ctx.lineTo(0, window.innerWidth);
//   ctx.fill();
//   ctx.beginPath();
//   ctx.moveTo(0, window.innerWidth);
//   ctx.fillStyle = blue;
